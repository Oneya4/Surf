...
class SurfTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: Consumer<Destinations>(
        builder: (context, destinations, _) => ListView.separated(
          ...
          itemBuilder: (ctx, index) => GestureDetector(
            onTap: () => Navigator.of(context).pushNamed(
              ...
              arguments: destinations.destinationList[index].id,
            ),
            child: Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: NetworkImage(
                      destinations.destinationList[index].imageUrl),
                  fit: BoxFit.cover,
                ),
